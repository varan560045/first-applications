...
public class StudentRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сортировка по списку и среднему баллу:");
        System.out.println(getResultObject(map2, students));
    }
    public static Map<Integer, ResultObject> getResultObject(Map<Integer, List<String>> sortedStudentList,
                                                             List<Students> students) {
        return sortedStudentList.entrySet()
                .stream()
                .collect(Collectors.toMap(Map.Entry::getKey, entry -> new ResultObject(entry.getValue(),
                                students.stream()
                                        .filter(student -> student.getCourseNumber() == entry.getKey())
