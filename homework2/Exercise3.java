...
public class Exercise3 {
    ...
    public static double sum(int term, double salary, double increase, double spending, double brokerageAccount){
        double result = 0;
    ...
    public static double balanceBrokerAccount(double salary, double increase, double brokerAccount, double income,
                                              int term){
        double result = 0;
